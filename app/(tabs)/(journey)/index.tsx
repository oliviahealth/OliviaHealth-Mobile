...
export default function JourneyScreen() {
  ...
  const points: Point[] = useMemo(
    ...
    [
      HORIZONTAL_CHANGE,
      isConceptionModalVisible,
      isFirstTrimesterModalVisible,
      isLaborAndDeliveryModalVisible,
      isNewbornModalVisible,
      isPostpartumModalVisible,
      isPreconceptionModalVisible,
      isPrematureBirthModalVisible,
      isSecondTrimesterModalVisible,
      isThirdTrimesterModalVisible,
      isYearOneModalVisible,
      isYearThreeModalVisible,
      isYearTwoModalVisible,
      width,
    ],
  );
  ...
  // Prevents rerendering of mock percentages
  const progressValues = useMemo(
    () => points.map(() => Math.random() * 100),
    [], // Empty deps to compute once
  );
